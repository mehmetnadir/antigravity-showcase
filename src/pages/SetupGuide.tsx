                ...
                <div className="space-y-6 order-2 md:order-1">
                    <div className="p-6 bg-amber-50 rounded-2xl border border-amber-100">
                        ...
                        <p className="text-sm text-amber-800 leading-relaxed">
                            Antigravity, dosyalarınızı yönetmek için güvenli bir alana ihtiyaç duyar. Asla "Downloads" veya "Desktop" kök dizinini seçmeyin.
                            Her zaman temiz, proje için ayrılmış <strong>yeni bir klasör</strong> (Örn: <code>/Users/ad/Desktop/IlkProjem</code>) oluşturun ve onu tanımlayın.
                            Bu, yapay zekanın dosyalarınızı karıştırmasını engeller.
                        </p>
                    </div>

                    <div>
                        <h3 className="text-2xl font-bold text-slate-900 mb-2">Kurulumdan Sonra?</h3>
                        <p className="text-slate-600 leading-relaxed">
                            Proje klasörünüzü seçtikten sonra Antigravity sizi karşılayacaktır. Artık sağ taraftaki panelden "Yeni Yetenek Ekle" diyerek projenize özellikler kazandırabilirsiniz.
                        </p>
                    </div>
                </div>
